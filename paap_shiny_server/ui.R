...
shinyUI(fluidPage(title="PAAP: A web server for predicting the antihypertensive activity of peptides", theme=shinytheme("united"),
                  useShinyjs(),
                  navbarPage(strong("PAAP"), collapsible = TRUE,
                             titleContent <- HTML("<b>PAAP</b>: A web server for predicting the antihypertensive activity of peptides"),
                             ...
                             copyright <- div(HTML("<br><table border=0 cellpadding=10 cellspacing=10 width='100%' height='50'><tr><td bgcolor='#f2f2f2' align='center'>Copyright © 2017 <a href='http://codes.bio'>codes.bio</a>. All rights reserved.</td></tr></table>")),
